...
class TestResources(BaseTest, BaseAuthMixin):
        ...
        self.assertEqual(
            obj.json["organization"],
            {
                ...
                "data": {
                    ...
                    "updated_at": "2020-04-15T12:40:14.462544",
                    "id": 1000,
                    "finess_et": "12345567890",
                    "finess_ej": "12345567890",
                },
                "created_at": "2020-04-15T12:40:14.462544",
                "updated_at": "2020-04-15T12:40:14.462544",
                "id": 1000,
                "name": "Hopital du Paradis",
                "type": 1,
                "reg_code": None,
            },
        )
    ...
    def test_create_availability_unknown_contact(self):
        ...
        self.assertEqual(response.json, {"errors": [{"code": "UNKNOWN_CONTACT", "message": "Unknown contact"}]})
    ...
    def test_create_availability_missing_contact_and_unknown_etablissement(self):
        ...
        self.assertEqual(
            ...
            {
                "errors": [
                    {"code": "UNKNOWN_ETABLISSEMENT", "message": "Unknown etablissement"},
                    {"code": "CREATE_CONTACT", "message": "lastname, firstname, email, phone_number are required"},
                ]
            },
        )
